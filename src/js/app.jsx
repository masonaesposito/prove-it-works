  ...
  render() {
    return (
      <div className='App'>
        ...
        <input onChange={this.handleChange} name='interestRate' id ='interest' />
        <input onChange={this.handleChange} name='loanTerm' id ='loan' />
        <select onChange={this.handleChange} name='period' id ='period'>
          <option value='12' id ='option'>Monthly</option>
          <option value='4' id ='option2'>Quarterly</option>
        </select>
